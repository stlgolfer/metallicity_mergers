...
class SensitivityProfile:
    def __init__(self, name: str, up_to_redshift: int, sensfile: str):
        ...
        if 'merger_rate' in sensfile:
            warnings.warn(f'merger_rate selected for {name}. make sure you set up_to_redshift correctly (is {up_to_redshift})')
