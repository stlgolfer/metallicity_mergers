import h5py as h5
file = h5.File('/Volumes/Elements/Boesky_sims.h5') 
# print(file.keys())
print(file['BSE_System_Parameters'].keys())
# print(file['Rates_mu00.035_muz0.035_alpha-1.778_sigma01.122_sigmaz0.049'].keys())
# print(file['Rates_mu00.035_muz0.035_alpha-1.778_sigma01.122_sigmaz0.049'])
